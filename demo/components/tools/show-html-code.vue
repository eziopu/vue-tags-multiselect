...
-->&lt;vue-tags-multiselect
  ...
  --><span v-show="verifyText(app.loadingPlaceholder)">  <span class="pln">:</span><span class="atn">loadingPlaceholder</span><span class="pun">=</span><span class="atv">"{{ app.loadingPlaceholder }}"</span><br></span><!--
  --><span v-show="verifyText(app.selectDownPlaceholder)">  <span class="pln">:</span><span class="atn">selectDownPlaceholder</span><span class="pun">=</span><span class="atv">"{{ app.selectDownPlaceholder }}"</span><br></span><!--
  --><span v-show="verifyText(app.finishPlaceholder)">  <span class="pln">:</span><span class="atn">finishPlaceholder</span><span class="pun">=</span><span class="atv">"{{ app.finishPlaceholder }}"</span><br></span><!--
-->&gt;<!--
